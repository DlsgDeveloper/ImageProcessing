...
namespace ImageProcessing
{
	/*public class AutoLevels
	{
		...
		public static void Get(Bitmap bitmap, Rectangle clip, double histogramOffsetMin, double histogramOffsetMax)
		{
			if (clip.IsEmpty)
			...
			try
			{
				HistogramGrayscale histogram = new HistogramGrayscale(bitmap, clip);
				...
				if (histogram.Lightest5Percent > histogram.Darkest5Percent)
				{
		...
		#region RunAlgorithm()
		internal static void RunAlgorithm(Bitmap bitmap, Rectangle clip, byte minimum, byte maximum)
		{
