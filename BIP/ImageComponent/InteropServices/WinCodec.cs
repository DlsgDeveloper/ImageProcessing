...
namespace ImageComponent.InteropServices
{
	...
	#region enum WICColorContextType
	...
	#region enum WICBitmapCreateCacheOption
	...
	#region enum WICBitmapEncoderCacheOption
	...
	#region enum WICComponentEnumerateOptions
	...
	#region enum WICBitmapInterpolationMode
	...
	#region enum WICBitmapPaletteType
	...
	#region enum WICBitmapDitherType
	...
	#region enum WICBitmapAlphaChannelOption
	...
	#region enum WICBitmapTransformOptions
	[Flags]
	...
	#region enum WICBitmapLockFlags
	[Flags]
	...
	#region enum WICBitmapDecoderCapabilities
	[Flags]
	...
	#region enum WICProgressOperation
	...
	#region enum WICProgressNotification
	...
	#region enum WICComponentSigning
	[Flags]
	...
	#region enum WICTiffCompressionOption
	...
	#region enum WICJpegYCrCbSubsamplingOption
	...
	#region enum WICNamedWhitePoint
	[Flags]
	...
	#region enum WICRawCapabilities
	...
	#region enum WICRawRotationCapabilities
	...
	#region enum WICRawParameterSet
	...
	#region enum WICRawChangeNotification
	[Flags]
	...
	#region enum WIC8BIMIPTCProperties
	...
	#region enum WIC8BIMResolutionInfoProperties
	...
	#region enum WICPngFilterOption
	...
	#region enum WICGifLogicalScreenDescriptorProperties
	...
	#region enum WICGifImageDescriptorProperties
	...
	#region enum WICGifGraphicControlExtensionProperties
	...
	#region enum WICGifApplicationExtensionProperties
	...
	#region enum WICSectionAccessLevel
	...
	#region enum WICPixelFormatNumericRepresentation
	...
	#region struct WICBitmapPattern
	...
	#region struct WICRawCapabilitiesInfo
	...
	#region struct WICRawToneCurvePoint
	...
	#region interface IPropertyBag2
	...
	#region interface IWICBitmapSource
	...
	#region interface IWICFormatConverter
	...
	#region interface IWICBitmapScaler
	...
	#region interface IWICBitmapClipper
	...
	#region interface IWICBitmapFlipRotator
	...
	#region interface IWICBitmapLock
	...
	#region interface IWICColorContext
	...
	#region interface IWICColorTransform
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICFastMetadataEncoder
	...
	#region interface IWICEnumMetadataItem
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICMetadataQueryReader
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICMetadataQueryWriter
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapEncoder
	...
	#region interface IWICBitmapFrameEncode
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapDecoder
	...
	#region interface IWICBitmapSourceTransform
	...
	#region interface IWICBitmapFrameDecode
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapCodecProgressNotification
	...
	#region interface IWICComponentInfo
	...
	#region interface IWICFormatConverterInfo
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapCodecInfo
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapEncoderInfo
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICBitmapDecoderInfo
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICPixelFormatInfo
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICImagingFactory
	...
	#region interface IWICDevelopRawNotificationCallback
	...
	#region interface IWICDevelopRaw
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	...
	#region interface IWICProgressiveLevelControl
	...
	#region interface IWICPixelFormatInfo2
	...
	#region class WICImagingFactory
	[ComImport]
